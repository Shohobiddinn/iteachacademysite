      ...
      <div class="container">
        <div class="logo">
          <NuxtLink :to="localePath('/')">
            <img :src="headerInfo?.header_logo" alt="logo" />
          </NuxtLink>
        </div>
        <ul class="menu">
          <li class="menu_li">
        ...
        <div class="set">
          <NuxtLink :to="localePath('/contact')" class="seti">{{
            $t("kirish")
          }}</NuxtLink>
        </div>
          ...
          <div class="nav_modal_language">
            <div class="lang_title">
              <NuxtLink
                ...
                :class="locale === loc.code ? 'active-lang' : ''"
      ...
      <div class="container">
        <div class="footer_content">
          <div class="footer_content_title">
            <div class="footer_content_title_name">{{ $t("footerTitle") }}</div>
            <div class="footer_content_title_text">
              {{ $t("footerTitle1") }}
            </div>
            <div class="footer_content_title_item email">
              <img :src="headerInfo?.email_image" alt="logo" />
              {{ headerInfo?.email }}
            </div>
            <div class="footer_content_title_item number">
              <img :src="headerInfo?.phone_image" alt="logo" />
              {{ headerInfo?.phone }}
            </div>
            <div class="footer_content_title_item location">
              <img :src="headerInfo?.location_image" alt="logo" />
              {{ headerInfo?.location }}
            </div>
          </div>
          <div class="footer_content_user">
            <div class="footer_content_user_title">{{ $t("aloqa") }}</div>
            <div class="footer_content_user_inputs">
              <input type="text" ref="name" :placeholder="$t('footerUser')" />
              <span :class="{ active: nameTitle }">{{ $t("input") }}</span>
            </div>
            <div class="footer_content_user_input phone">
              <input type="text" class="defoult_input" ref="phone" />
              <span :class="{ active: numberTitle }">{{ $t("input1") }}</span>
            </div>
            <div
              class="footer_content_user_courses course"
              :class="{ active: courseModal }"
            >
              <div
                class="footer_content_user_courses_option"
                ref="course"
                @click="courseModal = !courseModal"
              >
                {{ courseContent === "" ? $t("certificat1") : courseContent }}
              </div>
              <div class="footer_content_user_courses_content">
                <div
                  class="footer_content_user_courses_content_title"
            ...
            <div class="footer_content_user_send">
              <div class="footer_content_user_send_btn" @click="contactApi">
                {{ $t("footerUser4") }}
              </div>
            </div>
            <div class="footer_content_user_text">
              {{ $t("footerUser5") }}
            </div>
            <div class="footer_content_user_icons">
              <div class="footer_content_user_icons_icon">
                <nuxt-link
        ...
        <div class="footer_iframe" v-html="headerInfo?.map"></div>
        <div class="footer_menu">
          <div class="footer_menu_logo">
            <NuxtLink :to="localePath('/')">
              <img :src="headerInfo?.footer_logo" alt="logo" />
            </NuxtLink>
          </div>
          <div class="footer_menu_content">
            <ul class="footer_menu_content_title">
              <li class="footer_menu_content_title_item">
                <nuxt-link
                  :to="localePath('/')"
                  class="footer_menu_content_title_item_link"
                  >{{ $t("menu") }}</nuxt-link
                >
              </li>
              <li class="footer_menu_content_title_item">
